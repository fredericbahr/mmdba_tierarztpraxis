import {
  ...
  export const CustomerCard = ({ customer, allCustomers, setResults }: IProps) => {
    ...
    const handleDeleteRequest = async () => {
      ...
      console.log(result);
      const newCustomer = allCustomers.filter(customer => customer.id != result.deleteCustomer.id);
              ...
              <IconButton
                ...
                <Modal isOpen={isOpen} onClose={onClose}>
                  <ModalOverlay />
                    <ModalContent>
                      <ModalBody>
                        <Heading as="h4" size="md" p={5}>Wollen Sie den Kunden wirklich löschen?</Heading>
